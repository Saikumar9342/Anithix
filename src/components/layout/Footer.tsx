...
export function Footer() {
  return (
    <footer style={{ background: "transparent", paddingTop: "12rem", paddingBottom: "2rem", borderTop: "1px solid rgba(255,255,255,0.05)", position: "relative", overflow: "hidden", zIndex: 10 }}>
